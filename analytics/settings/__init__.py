...
DATABASES = {
    'default': {
        ...
        'OPTIONS': {
            ...
            # mmap_size is intentionally omitted: gunicorn workers each open
            # their own connection, and SQLite's mmap is documented as unsafe
            # for multi-process writers — it amplified an unrelated WAL
            # inconsistency into full database corruption in the status repo
            # on 2026-04-19.
            'init_command': (
